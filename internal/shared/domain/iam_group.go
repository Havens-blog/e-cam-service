...
// PermissionGroupFilter 权限组查询过滤器
...
// Validate 验证权限组数据
func (g *PermissionGroup) Validate() error {
	if g.Name == "" {
...
func (g *PermissionGroup) HasPolicy(policyID string, provider CloudProvider) bool {
...
// AddPolicy 添加权限策略
func (g *PermissionGroup) AddPolicy(policy PermissionPolicy) {
...
// RemovePolicy 移除权限策略
func (g *PermissionGroup) RemovePolicy(policyID string, provider CloudProvider) {
