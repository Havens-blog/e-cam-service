...
type ModelDAO interface {
	// CreateModel 创建模型
	CreateModel(ctx context.Context, model Model) (int64, error)
...
// CreateModel 创建模型
func (d *modelDAO) CreateModel(ctx context.Context, model Model) (int64, error) {
...
// GetModelByUID 根据UID获取模型
func (d *modelDAO) GetModelByUID(ctx context.Context, uid string) (Model, error) {
	var model Model
	col := d.db.Collection(ModelCollection)
...
// GetModelByID 根据ID获取模型
func (d *modelDAO) GetModelByID(ctx context.Context, id int64) (Model, error) {
	var model Model
	col := d.db.Collection(ModelCollection)
...
// ListModels 获取模型列表
func (d *modelDAO) ListModels(ctx context.Context, filter ModelFilter) ([]Model, error) {
	col := d.db.Collection(ModelCollection)
...
// CountModels 统计模型数量
func (d *modelDAO) CountModels(ctx context.Context, filter ModelFilter) (int64, error) {
	col := d.db.Collection(ModelCollection)
...
// UpdateModel 更新模型
func (d *modelDAO) UpdateModel(ctx context.Context, model Model) error {
	col := d.db.Collection(ModelCollection)
...
// DeleteModel 删除模型
func (d *modelDAO) DeleteModel(ctx context.Context, uid string) error {
	col := d.db.Collection(ModelCollection)
...
// ModelExists 检查模型是否存在
func (d *modelDAO) ModelExists(ctx context.Context, uid string) (bool, error) {
	col := d.db.Collection(ModelCollection)
