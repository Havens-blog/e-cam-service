...
func TestCloudAccount_Validate(t *testing.T) {
	tests := []struct {
		...
		{"缺少名称", CloudAccount{Provider: "aliyun", AccessKeyID: "ak", AccessKeySecret: "sk", TenantID: 1}, true},
		{"缺少Provider", CloudAccount{Name: "n", AccessKeyID: "ak", AccessKeySecret: "sk", TenantID: 1}, true},
		{"缺少AccessKeyID", CloudAccount{Name: "n", Provider: "aliyun", AccessKeySecret: "sk", TenantID: 1}, true},
		{"缺少AccessKeySecret", CloudAccount{Name: "n", Provider: "aliyun", AccessKeyID: "ak", TenantID: 1}, true},
