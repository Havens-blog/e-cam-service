...
func TestSyncRegionRedis_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", ctx, int64(6), "aliyun_redis", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
...
func TestSyncRegionRedis_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_redis", int64(100), "cn-hangzhou").
		Return([]string{"r-001", "r-old"}, nil)
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_redis", []string{"r-old"}).
		Return(int64(1), nil)
	...
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_redis", []string{"r-old"})
}
...
func TestSyncRegionMongoDB_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_mongodb", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
...
func TestSyncRegionEIP_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_eip", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionLB_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_lb", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionNAS_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_nas", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionKafka_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_kafka", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionElasticsearch_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_elasticsearch", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionDisk_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_disk", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionSnapshot_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_snapshot", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionSecurityGroup_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_security_group", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionImage_Success(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_image", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.MatchedBy(func(inst camdomain.Instance) bool {
...
func TestSyncRegionVPC_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_vpc", int64(100), "cn-hangzhou").
		Return([]string{"vpc-001", "vpc-old"}, nil)
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_vpc", []string{"vpc-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_vpc", []string{"vpc-old"})
}
...
func TestSyncRegionEIP_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_eip", []string{"eip-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_eip", []string{"eip-old"})
}
...
func TestSyncRegionMongoDB_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_mongodb", []string{"dds-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_mongodb", []string{"dds-old"})
}
...
func TestSyncRegionLB_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_lb", []string{"lb-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_lb", []string{"lb-old"})
}
...
func TestSyncRegionNAS_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_nas", []string{"nas-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_nas", []string{"nas-old"})
}
...
func TestSyncRegionKafka_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_kafka", []string{"kafka-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_kafka", []string{"kafka-old"})
}
...
func TestSyncRegionElasticsearch_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_elasticsearch", []string{"es-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_elasticsearch", []string{"es-old"})
}
...
func TestSyncRegionDisk_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_disk", []string{"d-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_disk", []string{"d-old"})
}
...
func TestSyncRegionSnapshot_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_snapshot", []string{"s-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_snapshot", []string{"s-old"})
}
...
func TestSyncRegionSecurityGroup_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_security_group", []string{"sg-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_security_group", []string{"sg-old"})
}
...
func TestSyncRegionImage_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_image", []string{"m-old"}).
		Return(int64(1), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_image", []string{"m-old"})
}
...
func TestSyncRegionECS_WithDeletion(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_ecs", mock.MatchedBy(func(ids []string) bool {
		return len(ids) == 2
	})).Return(int64(2), nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	assert.Equal(t, 1, synced)
	instanceRepo.AssertCalled(t, "DeleteByAssetIDs", c, int64(6), "aliyun_ecs", mock.Anything)
}
...
func TestSyncRegionAssets_SingleType_RDS(t *testing.T) {
	...
	instanceRepo.On("ListAssetIDsByRegion", c, int64(6), "aliyun_rds", int64(100), "cn-hangzhou").
		Return([]string{}, nil)
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
...
func TestSyncRegionECS_DeleteError(t *testing.T) {
	...
	instanceRepo.On("DeleteByAssetIDs", c, int64(6), "aliyun_ecs", []string{"i-old"}).
		Return(int64(0), fmt.Errorf("delete error"))
	instanceRepo.On("Upsert", c, mock.Anything).Return(nil)
