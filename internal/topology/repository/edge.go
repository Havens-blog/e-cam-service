...
type EdgeRepository interface {
	...
	FindBySourceID(ctx context.Context, tenantID int64, sourceID string) ([]domain.TopoEdge, error)
	// FindByTargetID 查询指定目标节点的所有入边
	FindByTargetID(ctx context.Context, tenantID int64, targetID string) ([]domain.TopoEdge, error)
	// FindByNodeID 查询与指定节点相关的所有边
	FindByNodeID(ctx context.Context, tenantID int64, nodeID string) ([]domain.TopoEdge, error)
	// Count 按过滤条件统计连线数量
	...
	DeleteByNodeID(ctx context.Context, tenantID int64, nodeID string) (int64, error)
...
func (r *edgeRepository) FindBySourceID(ctx context.Context, tenantID int64, sourceID string) ([]domain.TopoEdge, error) {
	return r.dao.FindBySourceID(ctx, tenantID, sourceID)
}

func (r *edgeRepository) FindByTargetID(ctx context.Context, tenantID int64, targetID string) ([]domain.TopoEdge, error) {
	return r.dao.FindByTargetID(ctx, tenantID, targetID)
}

func (r *edgeRepository) FindByNodeID(ctx context.Context, tenantID int64, nodeID string) ([]domain.TopoEdge, error) {
...
func (r *edgeRepository) DeleteBySource(ctx context.Context, tenantID int64, source string) (int64, error) {
	return r.dao.DeleteBySource(ctx, tenantID, source)
}

func (r *edgeRepository) DeleteByNodeID(ctx context.Context, tenantID int64, nodeID string) (int64, error) {
	return r.dao.DeleteByNodeID(ctx, tenantID, nodeID)
}

func (r *edgeRepository) UpdatePendingEdges(ctx context.Context, tenantID int64, targetID string) (int64, error) {
