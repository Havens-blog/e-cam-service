...
- This phase's task records: `docs/features/ssl-cert-management/tasks/records/4.*.md`
- This phase's summary: `docs/features/ssl-cert-management/tasks/records/4-summary.md`
