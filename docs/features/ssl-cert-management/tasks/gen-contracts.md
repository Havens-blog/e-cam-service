...
Generate test Contract specifications for the ssl-cert-management feature.
Mode: breakdown
...
2. **Read Journeys**: Enumerate Journey directories under `docs/features/ssl-cert-management/testing/` and read each `journey.md`
...
6. **Write Output**: Write Contract files to `docs/features/ssl-cert-management/testing/<journey>/contracts/` and Fact Table to `.forge/fact-table.json`
