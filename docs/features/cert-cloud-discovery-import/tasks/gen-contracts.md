...
Generate test Contract specifications for the cert-cloud-discovery-import feature.
Mode: quick
...
2. **Read Journeys**: Enumerate Journey directories under `docs/features/cert-cloud-discovery-import/testing/` and read each `journey.md`
...
6. **Write Output**: Write Contract files to `docs/features/cert-cloud-discovery-import/testing/<journey>/contracts/` and Fact Table to `.forge/fact-table.json`
